# This code is modified from the Biopython distribution, which is governed by its
# license.  Please see https://github.com/biopython/biopython/blob/master/LICENSE.rst
...
#Files are explicitly dual licensed under your choice of the "Biopython License Agreement" or the "BSD 3-Clause License". This is with the intention of later offering all of Biopython under this dual licensing approach.
...
class SummaryInfo(object):
    ...
    def iupac_consensus(self, threshold=0, ambiguous="X",
